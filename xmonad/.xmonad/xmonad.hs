...
myAppGrid = [ ("Dolphin", "dolphin")
                 , ("Visul Studio Code", "code")
                 , ("PhpStorm", "pstorm")
                 , ("NeoChat", "neochat")
                 , ("Firefox", "firefox")
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        , ("M-o", spawn "dmenu_run -fn 'Operator Mono' -x '450' -y '250' -h '5' -w '500'  -p 'Run: '") -- Dmenu
        , ("M1-<Space>", spawn "rofi -combi-modi window,drun -show combi -modi combi -font 'DejaVu Sans 10' -show-icons") -- Dmenu
    ...
    -- KB_GROUP Multimedia Keys
        ...
        , ("<XF86HomePage>", spawn "qutebrowser https://www.youtube.com/")
