...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F6", function () awful.util.spawn( "mpv --video-on-top" ) end,
        {description = "mpv" , group = "function keys" }),
    ...
    -- ctrl + shift + ...
    awful.key({ modkey1, "Shift"  }, "Escape", function() awful.util.spawn("htop") end),
