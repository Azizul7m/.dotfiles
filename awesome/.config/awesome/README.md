...
```
yay -S awesome rofi picom  xclip ttf-roboto polkit-gnome materia-theme lxappearance flameshot pnmixer pavucontrol acpi  network-manager-applet xfce4-power-manager qt5-styleplugins papirus-icon-theme -y
```
