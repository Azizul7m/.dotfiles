...
```
yay -S awesome tlp tlp-rdw  rofi picom roficlip gvfs-mtp  xclip ttf-roboto polkit-gnome materia-theme lxappearance flameshot pnmixer pipewire yad pavucontrol acpi  network-manager-applet  qt5-styleplugins  -y
```
