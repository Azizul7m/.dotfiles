...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioMute", function () awful.util.spawn("pactl set-sink-mute 0", false) end),
    ...
    awful.util.spawn('xterm')  end,
            {description = "xterm", group = "launcher"}),
    ...
    -- Menubar
    awful.key({ modkey , "Control"}, "p", function() awful.spawn.with_shell("exec launcher") end,
